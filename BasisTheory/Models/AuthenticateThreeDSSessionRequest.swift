...
public struct AuthenticateThreeDSSessionRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(authenticationCategory: String, authenticationType: String, cardBrand: String? = nil, challengePreference: String? = nil, requestDecoupledChallenge: Bool? = nil, decoupledChallengeMaxTime: Int? = nil, purchaseInfo: ThreeDSPurchaseInfo? = nil, merchantInfo: ThreeDSMerchantInfo? = nil, requestorInfo: ThreeDSRequestorInfo? = nil, cardholderInfo: ThreeDSCardholderInfo? = nil, broadcastInfo: JSONValue? = nil, messageExtensions: [ThreeDSMessageExtension]? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try containerEncoder.encodeIfPresent(requestorInfo, forKey: .requestorInfo)
