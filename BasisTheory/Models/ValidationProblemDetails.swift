...
public struct ValidationProblemDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(errors: [String: [String]]? = nil, type: String? = nil, title: String? = nil, status: Int? = nil, detail: String? = nil, instance: String? = nil) {
        self.errors = errors
        self.type = type
        self.title = title
        self.status = status
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try containerEncoder.encodeIfPresent(errors, forKey: .errors)
    ...
    public init(from decoder: Decoder) throws {
        ...
        nonAdditionalPropertyKeys.insert("errors")
