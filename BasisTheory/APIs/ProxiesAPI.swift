...
open class ProxiesAPI {
     ...
     */
    @discardableResult
    open class func callGet(id: [UUID]? = nil, name: String? = nil, page: Int? = nil, size: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ProxyPaginatedList?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func callGetWithRequestBuilder(id: [UUID]? = nil, name: String? = nil, page: Int? = nil, size: Int? = nil) -> RequestBuilder<ProxyPaginatedList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ProxyPaginatedList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func create(createProxyRequest: CreateProxyRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Proxy?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createWithRequestBuilder(createProxyRequest: CreateProxyRequest) -> RequestBuilder<Proxy> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Proxy>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getById(id: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Proxy?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func update(id: UUID, updateProxyRequest: UpdateProxyRequest, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Proxy?, _ error: Error?) -> Void)) -> RequestTask {
