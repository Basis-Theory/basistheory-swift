...
open class BasisTheoryAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.basistheory.com",
    ...
    public static let shared = BasisTheoryAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable {
    ...
    public let apiConfiguration: BasisTheoryAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: BasisTheoryAPIConfiguration = BasisTheoryAPIConfiguration.shared) {
        self.method = method
